...
namespace AutoVersion{
	...
	static const long REVISION  = 321;
	
	//Miscellaneous Version Types
	static const long BUILDS_COUNT  = 1804;
	#define RC_FILEVERSION 1,7,66,321
	#define RC_FILEVERSION_STRING "1, 7, 66, 321\0"
	static const char FULLVERSION_STRING [] = "1.7.66.321";
