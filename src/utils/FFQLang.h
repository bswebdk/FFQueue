...
const FFQ_SID SID_PRESET_CHANGE_QUALITY_LIMITS      = SID_PRESET_BASE + 116;
const FFQ_SID SID_PRESET_FLOATING_POINT             = SID_PRESET_BASE + 117;
const FFQ_SID SID_PRESET_CONSTANT_QUALITY           = SID_PRESET_BASE + 118;
const FFQ_SID SID_PRESET_ERROR_DETECT               = SID_PRESET_BASE + 119;
