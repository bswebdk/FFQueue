...
class FFQProcess : public wxEvtHandler
{
    ...
    public:
        ...
        void ExecuteAndWait();
        bool ExtractFrameFromFile(wxString file_name, TIME_VALUE frame_time, wxImage *img, size_t timeout = 0, size_t accuracy = 0, wxSize fit_to = wxDefaultSize);
