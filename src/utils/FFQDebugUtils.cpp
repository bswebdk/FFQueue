...
wxString CreateMakefiles(wxString cbp_path)
{
    ...
    makefile_am += "FFQ_EXENAME=ffqueue" + LBR;
    //makefile_am += "FFQ_LOCALE=../locale" + LBR;
    makefile_am += "FFQ_RES=../res" + LBR + LBR;
    ...
    makefile_am += "\t   @FFQ_ID=$$FFQ_IR/16x16/apps" + LBR;
    makefile_am += "\t   @mkdir -p $$FFQ_ID" + LBR;
    makefile_am += "\t   @cp $(FFQ_RES)/MainLogo16.png $$FFQ_ID/$(FFQ_EXENAME).png" + LBR;
    makefile_am += "\t   @FFQ_ID=$$FFQ_IR/32x32/apps" + LBR;
    makefile_am += "\t   @mkdir -p $$FFQ_ID" + LBR;
    makefile_am += "\t   @cp $(FFQ_RES)/MainLogo32.png $$FFQ_ID/$(FFQ_EXENAME).png" + LBR;
    makefile_am += "\t   @FFQ_ID=$$FFQ_IR/64x64/apps" + LBR;
    makefile_am += "\t   @mkdir -p $$FFQ_ID" + LBR;
    makefile_am += "\t   @cp $(FFQ_RES)/MainLogo64.png $$FFQ_ID/$(FFQ_EXENAME).png" + LBR;
    makefile_am += "\t   @mkdir -p $$FFQ_DST/applications" + LBR;
    makefile_am += "\t   @cp $(FFQ_RES)/$(FFQ_EXENAME).desktop $$FFQ_DST/applications/" + LBR;
    makefile_am += "\t @else" + LBR;
    makefile_am += "\t   @xdg-icon-resource install --novendor --size 16 $(FFQ_RES)/MainLogo16.png $(FFQ_EXENAME)" + LBR;
    makefile_am += "\t   @xdg-icon-resource install --novendor --size 32 $(FFQ_RES)/MainLogo32.png $(FFQ_EXENAME)" + LBR;
    makefile_am += "\t   @xdg-icon-resource install --novendor --size 64 $(FFQ_RES)/MainLogo64.png $(FFQ_EXENAME)" + LBR;
    ...
    makefile_am += "\t   @FFQ_IR=$$FFQ_DST/icons/hicolor" + LBR;
    makefile_am += "\t   @FFQ_ID=$$FFQ_IR/16x16/apps" + LBR;
    makefile_am += "\t   @rm -f $$FFQ_ID/$(FFQ_EXENAME).png" + LBR;
    makefile_am += "\t   @FFQ_ID=$$FFQ_IR/32x32/apps" + LBR;
    makefile_am += "\t   @rm -f $$FFQ_ID/$(FFQ_EXENAME).png" + LBR;
    makefile_am += "\t   @FFQ_ID=$$FFQ_IR/64x64/apps" + LBR;
    makefile_am += "\t   @rm -f $$FFQ_ID/$(FFQ_EXENAME).png" + LBR;
    makefile_am += "\t   @rm -f $$FFQ_DST/applications/$(FFQ_EXENAME).desktop" + LBR;
    makefile_am += "\t @else" + LBR;
    makefile_am += "\t   @xdg-icon-resource uninstall --novendor --size 16 $(FFQ_EXENAME)" + LBR;
    makefile_am += "\t   @xdg-icon-resource uninstall --novendor --size 32 $(FFQ_EXENAME)" + LBR;
    makefile_am += "\t   @xdg-icon-resource uninstall --novendor --size 64 $(FFQ_EXENAME)" + LBR;
    //makefile_am += "\t   xdg-desktop-icon uninstall --novendor $(FFQ_EXENAME).desktop" + LBR;
    makefile_am += "\t   @xdg-desktop-menu uninstall --novendor $(FFQ_EXENAME).desktop" + LBR;
    makefile_am += "\t @fi" + LBR;
