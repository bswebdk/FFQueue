...
FFQVidStab::FFQVidStab(wxWindow* parent)
{
	...
	Shakiness = new wxSlider(Page0, ID_SHAKINESS, 5, 1, 10, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_SHAKINESS"));
	...
	Accuracy = new wxSlider(Page0, ID_ACCURACY, 15, 1, 15, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_ACCURACY"));
	...
	StepSize = new wxSlider(Page0, ID_STEPSIZE, 6, 1, 32, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_STEPSIZE"));
	...
	MinContrast = new wxSlider(Page0, ID_MINCONTRAST, 30, 0, 100, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_MINCONTRAST"));
	...
	TripodFrame = new wxSpinCtrl(Page0, ID_TRIPODFRAME, _T("0"), wxDefaultPosition, wxDefaultSize, 0, 0, 10000000, 0, _T("ID_TRIPODFRAME"));
	...
	Smoothing = new wxSpinCtrl(Page1, ID_SMOOTHING, _T("10"), wxDefaultPosition, wxDefaultSize, 0, 0, 10000000, 10, _T("ID_SMOOTHING"));
	...
	MaxShift = new wxSpinCtrl(Page1, ID_MAXSHIFT, _T("0"), wxDefaultPosition, wxDefaultSize, 0, -1, 1000000, 0, _T("ID_MAXSHIFT"));
	...
	MaxAngle = new wxSpinCtrl(Page1, ID_MAXANGLE, _T("0"), wxDefaultPosition, wxDefaultSize, 0, -1, 180, 0, _T("ID_MAXANGLE"));
	...
	Zoom = new wxSpinCtrl(Page1, ID_ZOOM, _T("0"), wxDefaultPosition, wxDefaultSize, 0, -100, 100, 0, _T("ID_ZOOM"));
	Zoom->SetValue(_T("0"));
	...
	ZoomSpeed = new wxSpinCtrl(Page1, ID_ZOOMSPEED, _T("0"), wxDefaultPosition, wxDefaultSize, 0, 0, 100, 0, _T("ID_ZOOMSPEED"));
