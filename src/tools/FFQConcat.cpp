...
FFQConcat::FFQConcat(wxWindow* parent)
{
	...
	FlexGridSizer12->Add(CCAdd, 1, wxALL|wxEXPAND, 3);
	...
	FlexGridSizer12->Add(CCRemove, 1, wxALL|wxEXPAND, 3);
	...
	FlexGridSizer12->Add(CCUp, 1, wxALL|wxEXPAND, 3);
	...
	FlexGridSizer12->Add(CCDown, 1, wxALL|wxEXPAND, 3);
